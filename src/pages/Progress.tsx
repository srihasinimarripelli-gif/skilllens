...
export const Progress: React.FC = () => {
  ...
  const badges = [
    {
      id: 'first-drill',
      title: 'First Practice Drill',
      description: 'Completed your first hands-on technique session',
    ...
    },
    {
      ...
      description: 'Maintained an active 3+ day practice streak',
    ...
    },
    {
      id: 'craft-virtuoso',
      title: 'Form Master',
      description: 'Achieved an overall evaluation score above 85%',
    ...
    },
    {
      ...
      description: 'Practiced drills in at least 3 categories',
  ...
  return (
    <div className="min-h-screen pb-24 md:pb-12 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-250">
      <Header title="My Progress" subtitle="Learning statistics & activity" />
      ...
      <PageTransition className="px-4 sm:px-6 lg:px-8 py-6 max-w-5xl mx-auto w-full flex flex-col gap-8">
        ...
        <div className="border-b border-slate-100 dark:border-slate-800 pb-4">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Track your completed lessons, practice consistency, and craft mastery.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors duration-250">
            <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">Skills Learning</span>
            <div className="text-2xl sm:text-3xl font-extrabold text-blue-600 dark:text-blue-400 mt-2 leading-none">
              {skillsLearningCount}
            </div>
            <span className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Active courses</span>
          </div>

          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors duration-250">
            <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">Skills Completed</span>
            ...
            <span className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Passed benchmarks</span>
          </div>

          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors duration-250">
            <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">Practice Sessions</span>
            ...
            <span className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Recorded sessions</span>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors duration-250">
            ...
            <div className="text-2xl sm:text-3xl font-extrabold text-amber-600 dark:text-amber-400 mt-2 leading-none flex items-center gap-1.5">
              ...
              <span className="text-sm font-semibold text-amber-700 dark:text-amber-300">days</span>
            </div>
            <span className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">Daily practice</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-xs flex flex-col gap-4 transition-colors duration-250">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-3">
            ...
            <span className="text-xs text-slate-500 dark:text-slate-400">
              {CATEGORIES.length} Craft Disciplines
            </span>
          </div>
              ...
              <div key={cat.id} className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-slate-500 dark:text-slate-400 font-medium">
                    {cat.count} / {cat.total} skills practiced
                  </span>
                </div>
